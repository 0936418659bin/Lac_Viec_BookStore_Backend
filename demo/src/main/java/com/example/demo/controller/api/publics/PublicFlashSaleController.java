package com.example.demo.controller.api.publics;
...
public class PublicFlashSaleController {
    ...
    public ResponseEntity<Page<FlashSaleItemDTO>> getActiveFlashSaleItems(
        ...
        org.springframework.data.domain.Page<FlashSaleItemDTO> activeItems = flashSaleService.getActiveFlashSaleItems(pageable);

...
public class CartService {
    ...
    public CartItemDTO updateCartItemQuantity(Long itemId, int quantity) {
        ...
        log.info("Đã cập nhật số lượng sản phẩm. CartItem ID: {}, Số lượng mới: {}", itemId, quantity);
    ...
    public void clearCart() {
        ...
        log.info("Đã xóa toàn bộ {} sản phẩm khỏi giỏ hàng. User ID: {}", deletedCount, currentUser.getId());
    }
    ...
    public void checkout() {
        ...
        log.info("Đã thanh toán thành công giỏ hàng. User ID: {}, Số sản phẩm: {}",
                currentUser.getId(), cart.getItems().size());
    }
